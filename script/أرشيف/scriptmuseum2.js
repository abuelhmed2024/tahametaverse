          ...
          // Sky material
        	...
        	*/
        	...
        	setSkyConfig("material.inclination", skyboxMaterial.inclination, 0);
				...
				box5.rotation.x=3.14/2;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/16.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box5.material = material;
				...
				var box22 = new BABYLON.MeshBuilder.CreateBox("box51", { width: 30, height: 21, depth: 0.2 }, scene);
				box22.position.x = 75;
				box22.position.y = 30;
				...
				box41.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/109.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box41.material = material;
				...
				box41.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/307.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box41.material = material;
				//308
				...
				box41.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/308.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box41.material = material;
				//309
				...
				box41.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/309.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box41.material = material;
				...
				box31.position.y=20;
				box31.position.z=225;
				box31.rotation.x=3.14/2;
				box31.rotation.y=0;
				box31.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/407.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				...
				box31.position.x=50.5;
				box31.position.y=20;
				box31.position.z=200;
				box31.rotation.x=3.14/2;
				box31.rotation.y=0;
				box31.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/408.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box31.material = material;
				//409
				...
				box31.position.x=50.5;
				box31.position.y=20;
				box31.position.z=175;
				box31.rotation.x=3.14/2;
				box31.rotation.y=0;
				box31.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/409.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box31.material = material;
				...
				box31.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/507.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box31.material = material;
				//508
				...
				box31.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/508.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box31.material = material;
				//509
				...
				box31.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/509.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box31.material = material;
				//إنشاء لوحات الجانب الجنوبي
				...
				box31.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/607.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box31.material = material;
				//608
				...
				box31.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/608.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box31.material = material;
				//609
				...
				box31.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/609.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box31.material = material;
				//إنشاء لوحات الجانب الجنوبي
				...
				box41.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/707.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box41.material = material;
				//708
				...
				box41.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/708.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box41.material = material;
				//709
				...
				box41.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/709.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box41.material = material;
				...
				box41.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/807.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box41.material = material;
				//808
				...
				box41.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/808.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box41.material = material;
				//809
				...
				box41.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/809.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box41.material = material;
				...
				box41.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/907.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box41.material = material;
				//908
				...
				box41.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/908.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box41.material = material;
				//909
				...
				box41.rotation.z=0;
				var material = new BABYLON.StandardMaterial("material", scene);
				material.diffuseTexture = new BABYLON.Texture( "img/909.jpg", scene);
				material.diffuseTexture.hasAlpha = true;
				material.backFaceCulling = false;
				box41.material = material;
